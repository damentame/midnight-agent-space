...
BEGIN
    ...
    -- Optionally update main.task.status based on execution outcome so that
    -- fn_get_next_ready_task will not continue to return already executed tasks.
    IF EXISTS (
        SELECT 1 FROM information_schema.tables
        WHERE table_schema = 'main' AND table_name = 'task'
    ) THEN
...
-- ============================================================
-- 10b. FUNCTION: main.fn_peek_ready_tasks
-- ============================================================
-- Same ready-task selection as fn_get_next_ready_task, returns up to p_limit tasks as JSON array.
...
-- ============================================================
-- 11. FUNCTION: main.fn_get_or_create_code_document
-- ============================================================
